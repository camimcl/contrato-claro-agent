...
| Exploração manual e interface | [Sessão exploratória](SESSAO-EXPLORATORIA.md), [assistir à demonstração do Streamlit](https://github.com/user-attachments/assets/d04ef1bc-358c-4d11-b99a-23e92d988be1) e [cópia MP4 preservada](../evidence/demo/demo-streamlit.mp4). |
